...
export default function Home() {
  return (
    <main className="h-screen w-screen flex flex-col bg-black overflow-hidden metallic-overlay relative">
      ...
      <div className="flex-1 flex overflow-hidden min-h-0 relative z-10">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 flex min-h-0">
            ...
            className="w-1/2 border-r border-white/5 flex flex-col min-h-0 relative"
            style={{
